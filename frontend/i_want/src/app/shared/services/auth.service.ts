...
export class AuthService {
  ...
  public userAuthorizationData:
    | (IUserAuthorizationData & IUserAuthorizationResponse)
    | null = null;
  ...
  constructor(
    ...
    if (this.cookieService.hasKey('authData')) {
      this.userAuthorizationData = this.cookieService.getObject(
        'authData'
      ) as IUserAuthorizationData & IUserAuthorizationResponse;
      if (
